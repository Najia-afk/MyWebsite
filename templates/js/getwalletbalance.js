...
window.addEventListener("load", function() {
  ...
  document.getElementById("form").addEventListener("submit", function(event) {
    ...
    xhr.open("GET", "http://www.adventurecrypto.xyz:8000/getwalletbalance?wallet_address=" + walletAddress);
    xhr.send();
...
function getBalance() {
    ...
    xhttp.open("GET", "http://www.adventurecrypto.xyz:8000/getwalletbalance?wallet_address=" + wallet_address, true);
    xhttp.send();
}
